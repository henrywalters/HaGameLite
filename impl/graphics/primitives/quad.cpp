...
void hg::graphics::primitives::Quad::computeMesh() {
    ...
    Vec3 a = Vec3( -m_size[0] / 2.0f, -m_size[1] / 2.0f, 0.0f );
    Vec3 b = Vec3( -m_size[0] / 2.0f, m_size[1] / 2.0f, 0.0f );
    Vec3 c = Vec3( m_size[0] / 2.0f, m_size[1] / 2.0f, 0.0f );
    Vec3 d = Vec3( m_size[0] / 2.0f, -m_size[1] / 2.0f, 0.0f );
